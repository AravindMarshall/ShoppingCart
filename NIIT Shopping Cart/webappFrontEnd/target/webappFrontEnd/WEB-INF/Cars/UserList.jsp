...
<div class ="Container" align ="center">
	...
	<c:if test="${!empty userList}">
		<table class="tg">
			<tr>
				<th width="120"><center>User ID</center></th>
				<th width="200"><center>User Name</center></th>
				<th width="120"><center>User Password</center></th>
				<th width="100"><center>IsAdmin</center></th>
